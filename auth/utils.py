...
References:
    - Python hashlib.pbkdf2_hmac documentation: https://docs.python.org/3/library/hashlib.html#hashlib.pbkdf2_hmac
    - Python hmac.compare_digest documentaiton: https://docs.python.org/3/library/hmac.html#hmac.compare_digest
"""
