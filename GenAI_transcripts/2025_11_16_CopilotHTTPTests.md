...
Create a http.test.ts file for full coverage of apiRequest.ts. Format the same as the other included tests.

**Copilot**

Used 5 references
- auth.test.ts `frontend/web/src/tests`
- cookies.test.ts `frontend/web/src/tests`
- crypto.test.ts `frontend/web/src/tests`
- hasAccessToken.ts `frontend/web/src/utils/auth`
- apiRequest.ts `frontend/web/src/utils/http`
